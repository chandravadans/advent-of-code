...
class Dec02RedNosedReportsTest {

    private Dec02RedNosedReports underTest;

    @BeforeEach
    public void setup() {
        underTest = new Dec02RedNosedReports();
    }
    ...
    @Test
    @DisplayName("Part 2: Sample input")
    public void test02() {
        String input = """
                7 6 4 2 1
                1 2 7 8 9
                ...
                1 3 6 7 9
                """;
        assertEquals(4, underTest.part02(input));
    }

    @Test
    @DisplayName("Actual Input")
    public void test() {
        assertEquals(224, underTest.part01(getInput()));
        assertEquals(293, underTest.part02(getInput()));
    }
